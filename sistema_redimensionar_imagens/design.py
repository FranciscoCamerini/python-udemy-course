...
class Ui_RedimensionarImagem(object):
    def setupUi(self, RedimensionarImagem):
        RedimensionarImagem.setObjectName("RedimensionarImagem")
        RedimensionarImagem.resize(800, 600)
        self.centralwidget = QtWidgets.QWidget(RedimensionarImagem)
        ...
        RedimensionarImagem.setCentralWidget(self.centralwidget)

        self.retranslateUi(RedimensionarImagem)
        QtCore.QMetaObject.connectSlotsByName(RedimensionarImagem)

    def retranslateUi(self, RedimensionarImagem):
        _translate = QtCore.QCoreApplication.translate
        RedimensionarImagem.setWindowTitle(_translate("RedimensionarImagem", "MainWindow"))
        self.label.setText(_translate("RedimensionarImagem", "Largura"))
        self.btnRedimensionar.setText(_translate("RedimensionarImagem", "Redimensionar"))
        self.label_2.setText(_translate("RedimensionarImagem", "Altura"))
        self.btnSalvar.setText(_translate("RedimensionarImagem", "Salvar"))
        self.btnEscolherArquivo.setText(_translate("RedimensionarImagem", "Escolher Arquivo"))
